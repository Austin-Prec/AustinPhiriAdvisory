...
export default function ContactSidebarBlock({ content }: ContactSidebarBlockProps) {
  return (
    <div className="lg:col-span-2">
      <div className="rounded-2xl bg-gray-50 border border-gray-200 p-8 sticky top-28 transition-shadow duration-300 hover:shadow-[0_20px_50px_-20px_rgba(31,56,100,0.2)]">
        {content.heading && (
