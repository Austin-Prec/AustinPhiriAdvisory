    ...
    >
      ...
      <div className="relative">
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #D4A94F, #1F3864)' }}
          aria-hidden="true"
        />
        <img
          src={content.image_url}
          alt={content.alt || ''}
          className="relative w-full rounded-xl shadow-[0_25px_50px_-15px_rgba(31,56,100,0.35)] transition-transform duration-500 hover:scale-[1.015]"
        />
      </div>
        ...
        <div className="mt-6 space-y-3">
          {content.badges.map((badge, i) => {
            ...
            return (
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-crimson-50 flex items-center justify-center shrink-0">
                  <IconComponent size={16} className="text-crimson-400" />
                </div>
