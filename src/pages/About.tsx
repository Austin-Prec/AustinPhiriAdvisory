            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span className="font-arial text-sm">Board-Appointed CFO</span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                  <MapPin size={18} className="text-crimson-400" />
                  <span className="font-arial text-sm">Southern Africa</span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                  <Calendar size={18} className="text-crimson-400" />
                  <span className="font-arial text-sm">12+ years applied experience</span>
                </div>
              </div>
            </div>
