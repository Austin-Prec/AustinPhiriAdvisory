...
const CATEGORIES = ['Governance', 'Forensic Finance', 'Institutional Controls', 'Donor Compliance'];
const ICONS = ['Shield', 'Search', 'FileCheck', 'TrendingUp'];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={isSavingDraft || isPublishing}
              className="px-5 py-2 bg-crimson-400 text-white rounded-lg font-arial text-sm font-semibold hover:bg-crimson-500 transition-colors disabled:opacity-50"
            >
              {isPublishing
                ? 'Publishing…'
      ...
      <main className="max-w-4xl mx-auto px-6 md:px-10 py-8">
        {error && (
          <p className="font-arial text-crimson-400 text-sm mb-4 bg-crimson-50 border border-crimson-100 rounded-lg px-4 py-3">
            {error}
          </p>
        )}
