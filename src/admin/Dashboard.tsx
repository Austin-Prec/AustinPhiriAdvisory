    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-6 md:px-10 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            to="/admin/new"
            className="flex items-center gap-2 bg-crimson-400 text-white px-5 py-2.5 rounded-lg font-arial text-sm font-semibold hover:bg-crimson-500 transition-colors"
          >
        ...
        {loadError && (
          <p className="font-arial text-crimson-400 text-sm py-4">{loadError}</p>
        )}
        ...
        {!isLoading && !loadError && articles.length === 0 && (
          <div className="bg-white border border-gray-200 rounded-lg py-16 text-center">
            ...
            <Link
              to="/admin/new"
              className="inline-flex items-center gap-2 bg-crimson-400 text-white px-5 py-2.5 rounded-lg font-arial text-sm font-semibold hover:bg-crimson-500 transition-colors"
            >
              <Plus size={16} /> New post
            </Link>
          </div>
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                  ...
                  title="Delete"
                  className="p-2 text-gray-400 hover:text-crimson-400 transition-colors disabled:opacity-40"
                >
                  <Trash2 size={16} />
                </button>
              </div>
